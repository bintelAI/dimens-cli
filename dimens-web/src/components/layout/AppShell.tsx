...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f2ec] text-ink-950">
      <div className="flex min-h-screen">
        ...
        <main className="min-w-0 flex-1">
          <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-ink-900/10 bg-[#f5f2ec]/88 px-5 backdrop-blur">

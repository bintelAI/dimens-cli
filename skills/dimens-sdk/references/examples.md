...
- Web / H5 前端案例：`references/web-examples.md`
- 移动端 / App / 小程序案例：`references/mobile-examples.md`
- Node.js / Next.js / BFF 案例：`references/bff-examples.md`
...
如果你是第一次进入 `dimens-sdk`，优先按下面顺序看：

1. 前端首次接入：`references/frontend-quickstart.md`
2. 登录与 token 主链：`references/frontend-auth-flow.md`
3. React / Vue 落地示例：`references/react-auth-example.md`
4. 最佳实践：`references/sdk-best-practices.md`
5. refresh / retry：`references/request-retry-example.md`

如果你不是前端接入，而是按资源域排查或接入，直接进入对应文档：

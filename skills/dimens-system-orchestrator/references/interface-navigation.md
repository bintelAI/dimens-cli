...
1. 先看团队 / 项目上下文
2. 再看表 / 字段 / 行
3. 然后再按需扩展权限 / 工作流 / 报表 / 对接
4. 最后用总目录确认哪些能力已经 CLI 化
...
- 如需扩展权限：看 `dimens-permission/references/examples.md`、`matrix.md`
...
| 客户归属、公开访问、协同限制 | `dimens-permission/references/examples.md`、`matrix.md` | 必须明确准入、表级、列级、行级边界 |
